...
const SECTIONS: Section[] = [
  {
    ...
    topics: [
      ...
      { label: "Chemical Bonding", pct: 0 },
      { label: "Acids & Bases", pct: 0 },
      { label: "Thermodynamics", pct: 0 },
      { label: "Kinetics", pct: 0 },
      { label: "Electrochemistry", pct: 0 },
      { label: "Organic Reactions", pct: 0 },
      { label: "Stereochemistry", pct: 0 },
      { label: "Kinematics", pct: 0 },
      { label: "Force & Motion", pct: 0 },
  ...
  },
  {
    ...
    topics: [
      ...
      { label: "Strengthen & Weaken", pct: 0 },
      { label: "Author Purpose", pct: 0 },
  ...
  },
  {
    ...
    color: "#4ade80",
    topics: [
      { label: "Amino Acids & Proteins", pct: 0 },
      { label: "Enzyme Kinetics", pct: 0 },
      { label: "Metabolism & Glycolysis", pct: 0 },
      { label: "Krebs Cycle & Oxidative Phosphorylation", pct: 0 },
      { label: "DNA Replication", pct: 0 },
      { label: "Transcription & Translation", pct: 0 },
      { label: "Genetics & Heredity", pct: 0 },
      { label: "Cell Structure & Function", pct: 0 },
      { label: "Cell Signaling", pct: 0 },
      { label: "Immune System", pct: 0 },
      { label: "Nervous System", pct: 0 },
      { label: "Endocrine System", pct: 0 },
      { label: "Cardiovascular System", pct: 0 },
      { label: "Respiratory System", pct: 0 },
      { label: "Digestive System", pct: 0 },
  ...
  },
  {
    ...
    color: "#a78bfa",
    topics: [
      { label: "Classical Conditioning", pct: 0 },
      { label: "Operant Conditioning", pct: 0 },
      { label: "Memory", pct: 0 },
      { label: "Perception & Cognition", pct: 0 },
      { label: "Motivation & Emotion", pct: 0 },
      { label: "Developmental Psychology", pct: 0 },
      { label: "Personality Theories", pct: 0 },
      { label: "Psychological Disorders", pct: 0 },
      { label: "Social Behavior", pct: 0 },
      { label: "Groups & Norms", pct: 0 },
      { label: "Identity & Self", pct: 0 },
      { label: "Socialization", pct: 0 },
      { label: "Social Stratification", pct: 0 },
      { label: "Health & Stress", pct: 0 },
    ],
  },
];
